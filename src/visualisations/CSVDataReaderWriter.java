...
public class CSVDataReaderWriter {
    public static void main(String[] args) throws Exception {
        ...
        for (int i = 0; i <= 60; i+=1) {
            ...
            String[] str1 = {"-mess", "100000", "-snrpb", String.valueOf(i), "-form", "RZ", "-codeur", "-nbEch", "30", "-ampl", "0", "5"};
            String[] str2 = {"-mess", "100000", "-snrpb", String.valueOf(i), "-form", "NRZ",  "-codeur", "-nbEch", "30", "-ampl", "-5", "5"};
            String[] str3 = {"-mess", "100000", "-snrpb", String.valueOf(i), "-form", "NRZT",  "-codeur", "-nbEch", "30", "-ampl", "-5", "5"};
